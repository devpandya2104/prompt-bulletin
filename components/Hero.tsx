...
const quickFilters = ["Writing", "Image Gen", "Coding", "Video", "Productivity"];
    ...
    <section className="pt-36 pb-24 text-center relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-7" style={{ border: "1px solid var(--border2)", background: "rgba(255,255,255,0.04)" }}>
          ...
          <span className="text-[13px] font-medium" style={{ color: "var(--text2)" }}>1,200+ AI tools curated by real editors</span>
        </div>

        {/* Headline */}
        <h1
          className="font-bold leading-[1.08] tracking-tighter mb-5"
          style={{ fontFamily: "var(--font-space)", fontSize: "clamp(40px,7vw,64px)", color: "var(--text)" }}
        >
          Find the right AI tool.<br />
          <span style={{ color: "var(--accent)" }}>Trust the review.</span>
        </h1>

        <p className="text-lg leading-relaxed mb-10 mx-auto max-w-lg" style={{ color: "var(--text2)" }}>
          Editorial reviews, real upvotes, and structured comparisons — so you can discover the best AI tools in under 3 minutes.
        </p>

        {/* Search bar */}
        <div
          className="flex items-center gap-3 max-w-xl mx-auto mb-12 rounded-2xl px-4 py-1.5 transition-all duration-200"
          style={{
            background:  "var(--bg3)",
            border:      `1px solid ${isFocused ? "var(--accent)" : "var(--border2)"}`,
            boxShadow:   isFocused ? "0 0 0 3px oklch(72% 0.19 52 / 0.12)" : "none",
          }}
        >
