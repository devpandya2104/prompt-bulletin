            ...
            >
              ...
              <div className="p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs" style={{ color: "var(--text3)" }}>{post.readTime} read</span>
                </div>

                <h3 className="text-base font-bold leading-snug mb-4" style={{ fontFamily: "var(--font-space)", color: "var(--text)" }}>
                  {post.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs" style={{ color: "var(--text3)" }}>{post.author} · {post.date}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs" style={{ color: "var(--text3)" }}>{post.upvotes}</span>
                  </div>
                </div>
              </div>
            </article>
